...
Provides a list of all verified reviews 
...
***********************************************/
    ...
    /* Get list of all verified reviews for specified mentor */
    ...
    while ($row = mysqli_fetch_row($result1)) {
        /* Get info about mentee who wrote the review */
        ...
        /* Get info about the section that the mentor and mentee were enrolled in together*/
